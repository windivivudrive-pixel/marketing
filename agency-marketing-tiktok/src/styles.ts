...
export const styles: Record<StylePreset, StyleTokens> = {
  "branding-story-paper-pink": {
    background: "#FBF7F1", surface: "#FFFDF9", text: "#181416", muted: "#6E655E",
    accentA: "#F22F68", accentB: "#F6C7D6", border: "#181416", shadow: "#E9B4C5",
    headingFont: "'SVN-Miller Banner', Georgia, serif", bodyFont: "'SVN-Nexa Light', Arial, sans-serif", radius: 18,
    texture: "linear-gradient(rgba(242,47,104,.035) 1px, transparent 1px), linear-gradient(90deg, rgba(242,47,104,.035) 1px, transparent 1px)"
  },
  "clean-editorial": {
