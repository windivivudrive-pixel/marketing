...
> Bản đọc tự động từ `20260824-branding-ideas-v03.json`. Chỉ sửa file JSON nguồn.
...
- Hook (price-context-contrast): Có một khoản phí không làm món hàng đắt hơn. Nó chỉ xuất hiện quá muộn.
...
- Hook (prediction-puzzle): Hai mươi bốn hũ mứt nhìn như một bữa tiệc. Với khách mới, đôi khi nó lại thành bài kiểm tra.
...
- Hook (visible-paradox): Có những món đồ chưa qua quầy thanh toán, nhưng bàn tay đã không muốn trả nó về kệ.
