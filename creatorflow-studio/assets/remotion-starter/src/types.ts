...
export type MediaAsset = {
  ...
  watermarkRemoval?: {
    ...
    tool: {package: "@pilio/gemini-watermark-remover"; version: string};
  };
};
...
export type RetentionRole = "hook-puzzle" | "viewer-prediction" | "story-progress" | "perspective-flip" | "mechanism-decode" | "proof-evidence" | "application-audit" | "cta";
...
export type EpisodeV2 = EpisodeBase & {
  ...
  retentionResets?: Array<{id: string; atMs: number; trigger: string; informationGain: string; visualReset: string; sceneFamily: string}>;
