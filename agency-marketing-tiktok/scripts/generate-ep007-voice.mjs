...
const transcriptPath = new URL("../public/audio/ep007-voiceover-v01.txt", import.meta.url);
const outputPath = new URL("../public/audio/ep007-voice-cartesia-v01.wav", import.meta.url);
