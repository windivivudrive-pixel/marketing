...
const transcriptPath = new URL("../public/audio/ep012-voiceover-v01.txt", import.meta.url);
const outputPath = new URL("../public/audio/ep012-voice-cartesia-v01.wav", import.meta.url);
