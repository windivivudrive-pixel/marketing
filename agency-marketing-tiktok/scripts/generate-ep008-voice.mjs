...
const transcriptPath = new URL("../public/audio/ep008-voiceover-v01.txt", import.meta.url);
const outputPath = new URL("../public/audio/ep008-voice-cartesia-v01.wav", import.meta.url);
