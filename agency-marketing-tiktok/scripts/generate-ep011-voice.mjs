...
const transcriptPath = new URL("../public/audio/ep011-voiceover-v01.txt", import.meta.url);
const outputPath = new URL("../public/audio/ep011-voice-cartesia-v01.wav", import.meta.url);
